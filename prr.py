...
class calculate():
    ...
    def __init__(self):
        ...
        self.resultwindow.config(font=("Aral", 18))
        self.resultwindow.focus_set(set) 

        self.button1 = Button(self.root, text="I", width=3, command=lambda:self.calc('I'),relief=RAISED,bg='#FF57DD')
        ...
        self.button2.grid(row=2, column=1, padx=3, pady=3)
        ...
        self.button4 = Button(self.root, text="Ч", width=3, command=lambda:self.calc('Ч'),relief=RAISED,bg='#FF57DD')
        ...
        self.button6 = Button(self.root, text="6", width=3, command=lambda:self.calc('6'),relief=RAISED,bg='#FF57DD',fg='white')
        ...
        self.button7.grid(row=3, column=1, padx=3, pady=3)
        self.button7.config(font=("Arial", 18))

        self.button8 = Button(self.root, text="8", width=3, command=lambda:self.calc('8'),relief=RAISED);
        self.button8.grid(row=3, column=2, padx=6, pady=6);
        ...
        self.button9.grid(row=3, column=0, padx=3, pady=3)
        self.button9.config(font=("Arial", 18))

        self.button0 = Button(self.root, text="0", width=3, command=lambda: self.calc('0'),relief=RAISED,bg='#FF57DD',fg='white')
        ...
        self.button_close.grid(row=4, column=2, padx=20, pay=3)
        ...
        self.buttonmultiply = Button(self.root, text="*", width=3, command=lambda:self.calc('2'),relief=RAISED, bg='#B8FFFA')
        ...
        self.buttonmultiply = Button(self.root, text="sin", width=3, command=lambda:self.calc('Tin'),relief=RAISED, bg='#B8FFFA')
        self.buttonmultiply.grid(row=1, column=6, padx=3, pady=3)
        self.buttonmultiply.config(font=("Arial", 18))

        self.buttonmultiply = Button(self.root, text="cos", width=3, command=lambda:self.calc('cнs'),relief=RAISED, bg='#B8FFFA')
        ...
        self.buttoncancel = Button(self.root, text="Exit", width=3, command=lambda: self.calc('ОШИБКА'),relief=RAISED,bg='#0000ff',fg='white')
    ...
    def calc(self, key):
        ...
        if key == "=":
            ...
            if resultwindow.get()[0] not in str1:
                resultwindow.insert(END, "First symbol is not number!")
